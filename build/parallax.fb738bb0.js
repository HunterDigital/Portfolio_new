...
window.addEventListener('scroll', function () {
  ...
  if (wScroll <= pContainerHeight) {
    document.querySelector('.layer--2').style.transform = 'translate(0px, ' + wScroll / 60 + '%)';
    document.querySelector('.layer--3').style.transform = 'translate(0px, ' + wScroll / 40 + '%)';
    document.querySelector('.layer--4').style.transform = 'translate(0px, ' + wScroll / 20 + '%)';
  }
});
...
Typer.prototype.doTyping = function () {
  ...
  var currentDisplay = _toConsumableArray(this.words[w]).slice(0, c).join("");
  ...
  if (p.building) {
    if (p.char == _toConsumableArray(this.words[w]).length) {
      p.building = false;
      p.atWordEnd = true;
    } else {
      p.char += 1;
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","parallax.js"], null)
//# sourceMappingURL=/parallax.fb738bb0.js.map